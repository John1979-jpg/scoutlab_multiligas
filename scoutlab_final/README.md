...
- **Importacion de datos** desde CSV y HTML (WhoScored)
...
scoutlab/
    ...
    backend/
        ...
        data_import.py           Importacion desde CSV/HTML
    ...
    notebooks/
        00_generar_datos_sinteticos.py   Generacion de datos sinteticos
...
- **Transfermarkt**: Valores de mercado, datos contractuales, informacion personal
- **BeSoccer**: Estadisticas de rendimiento (goles, asistencias, minutos, tarjetas)
...
Proyecto Final de Master (TFM) - Master en Python Avanzado Aplicado al Deporte (MPAD)
